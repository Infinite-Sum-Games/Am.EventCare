...
// import { Activity, BarChart3, Clock, Hotel, LogOut, Users } from "lucide-react";
		...
		<aside className="w-64 bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col h-screen sticky top-0">
			...
			<nav className="flex-1 p-4 space-y-2">
				<Link
					...
					activeProps={{
						className:
							"flex items-center gap-3 p-3 rounded-lg bg-amber-500/10 backdrop-blur-md border border-amber-500/50 shadow-[0_0_15px_rgba(245,158,11,0.2)] text-amber-500 font-medium",
					}}
				>
					<Users size={20} />
					...
					<div className="flex items-center gap-3">
						...
						<div className="overflow-hidden">
							...
							<p className="text-xs text-muted-foreground truncate">
								{user?.email || "admin@pragati.amrita.edu"}
							</p>
						</div>
					</div>
